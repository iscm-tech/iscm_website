...
export default function Editor({
  ...
  async function updatePost(
    ...
    try {
      if (!metaForm.current) throw new Error("Invalid meta form");
      ...
      // Local thumbnail
      if (thumb)
        meta.thumbnail = `/images/evolving-research/${post.metadata.slug}/${thumb.name}`;

      if (portal_thumb) {
        meta.portal_thumb = `/images/evolving-research/${post.metadata.slug}/${portal_thumb.name}`;
      }

      if (portal_background) {
        meta.portal_background = `/images/evolving-research/${post.metadata.slug}/${portal_background.name}`;
      }
