...
export default function Editor({
  ...
  async function updatePost(
    ...
    try {
      ...
      // Local thumbnail
      if (thumb)
        meta.thumbnail = `/images/student_life/${post.metadata.slug}/${thumb.name}`;

      if (portal_thumb) {
        meta.portal_thumb = `/images/student_life/${post.metadata.slug}/${portal_thumb.name}`;
      }

      if (portal_background) {
        meta.portal_background = `/images/student_life/${post.metadata.slug}/${portal_background.name}`;
      }
