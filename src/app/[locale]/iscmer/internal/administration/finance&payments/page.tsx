  ...
  return (
    <div>
      ...
      <div className="content-body mt-5">
        ...
        <p>
          Mọi hoạt động thu chi tại ISCM được quản lý và đối chiếu dựa trên 2 hệ
          thống quy chế (được cập nhật hàng năm):
        </p>
        <ul className="list-disc! pl-4 mb-4">
          <li className="list-item!">
            Track 1 - Quy chế chi tiêu nội bộ UEH: Quy định các định mức chi
            tiêu ngân sách chuẩn của Trường dành cho hoạt động giáo dục, NCKH,
            và công tác phí (trong/ngoài nước). (Tra cứu tại hệ thống UEHer).
          </li>
          <li className="list-item!">
        ...
        <p>
          Nhằm đảm bảo hồ sơ được xử lý chính xác nguồn tiền và nhanh chóng, quy
          trình thanh toán được chia thành 4 luồng:
        </p>
        <ol className="list-decimal! pl-4 mb-4">
          ...
          <li className="list-item">
            Thanh toán Sự kiện/ Dự án/ Nghiên cứu (Event/ Project Payment) - Áp
            dụng theo Track 1
            <ul className="list-disc! pl-4">
              <li className="list-item!">
                Hạng mục: Chi phí tổ chức sự kiện, ngân sách NCKH, mua sắm thiết
                bị dự án...
              </li>
              <li className="list-item!">
                Người thực hiện: Người phụ trách trực tiếp (Head, Lead, Manager,
                Coordinator, Host).
              </li>
            </ul>
          </li>
          <li className="list-item">
            ...
            <ul className="list-disc! pl-4">
              ...
              <li className="list-item!">
                Người thực hiện: Nhóm chuyên trách Operation & Finance (Ms. Mai
                / Ms. Trâm).
              </li>
            </ul>
          </li>
          <li className="list-item">
            ...
            <ul className="list-disc! pl-4">
              <li className="list-item!">
                Hạng mục:
                <br />
                Thưởng phát triển dự án (Incentives) cho cá nhân kết nối thành
                công dự án/tài trợ.
                <br />
                Các khoản chi phúc lợi, hỗ trợ vận hành đặc thù thuộc quỹ riêng
                của Viện (không qua ngân sách UEH).
              </li>
              <li className="list-item!">
