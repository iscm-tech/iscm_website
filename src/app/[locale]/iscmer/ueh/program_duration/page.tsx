    ...
    <div className="py-4 container">
      ...
      <div className="content-body mt-5">
        ...
        <p className="text-justify">
          Khung thời gian đào tạo là kênh thông tin chính thức của Đại học Kinh
          tế Thành phố Hồ Chí Minh (UEH), được sử dụng để cập nhật các thông
          báo, lịch trình và kế hoạch học tập dành cho sinh viên và học viên
          trong từng giai đoạn đào tạo.
          <br />
          Hệ thống đóng vai trò quan trọng trong việc đảm bảo người học nắm bắt
          kịp thời các mốc thời gian và kế hoạch học tập theo quy định của Nhà
          trường.
        </p>
        ...
        <ul className="list-disc! pl-4 mb-4">
          ...
          <li className="list-item!">
            Hạn chế sai sót trong đăng ký học phần và tham gia các hoạt động học
            vụ
          </li>
        </ul>
        <p>
          Khung thời gian đào tạo là nguồn thông tin học vụ quan trọng, hỗ trợ
          người học trong việc quản lý tiến độ học tập và đảm bảo quá trình đào
          tạo diễn ra đúng kế hoạch, hiệu quả và đồng bộ với quy định của UEH.
        </p>
      </div>
    </div>
  );
