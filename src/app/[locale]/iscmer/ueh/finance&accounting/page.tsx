    ...
    <div className="py-4 container">
      ...
      <div className="content-body mt-5">
        ...
        <p className="text-justify">
          Hệ thống Tài chính Kế toán UEH là nền tảng số được phát triển nhằm hỗ
          trợ giảng viên và viên chức trong việc quản lý toàn diện các vấn đề
          tài chính liên quan đến cá nhân và đơn vị công tác.
          <br />
          Hệ thống hướng đến việc minh bạch hóa thông tin, chuẩn hóa quy trình
          và tối ưu hóa trải nghiệm người dùng, góp phần nâng cao hiệu quả quản
          trị tài chính trong toàn trường.
        </p>

        <h2>Các chức năng chính</h2>
        <h4>1. Kiểm tra thu nhập cá nhân</h4>
        <p>
        ...
        <p>
          Thông tin được cập nhật định kỳ, đảm bảo tính chính xác, minh bạch và
          dễ dàng đối chiếu, hỗ trợ người dùng chủ động trong việc theo dõi thu
          nhập cá nhân.
        </p>
        <h4>2. Thanh toán cá nhân</h4>
        <p>
          Người dùng có thể thực hiện các yêu cầu thanh toán và hoàn ứng trực
          tuyến đối với các chi phí phát sinh trong quá trình công tác, bao gồm:
        </p>
        <ul className="list-disc! pl-4 mb-4">
        ...
        <ul className="list-disc! pl-4 mb-4">
          <li className="list-item!">Tính minh bạch trong quản lý ngân sách</li>
          <li className="list-item!">Khả năng theo dõi theo thời gian thực</li>
          <li className="list-item!">
        ...
        <p>
          ...
          cho giảng viên, viên chức và các đơn vị trong việc quản lý tài chính,
          góp phần nâng cao chất lượng vận hành và phát triển bền vững của Nhà
          trường.
        </p>
      </div>
    </div>
