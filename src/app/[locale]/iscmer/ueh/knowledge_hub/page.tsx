      ...
      <div className="row mt-5">
        <div className="content-body col-9">
          ...
          <p className="text-justify">
            Kho tri thức UEH là nền tảng hỗ trợ tập trung, được xây dựng nhằm
            cung cấp thông tin, hướng dẫn và giải đáp các yêu cầu liên quan đến
            hoạt động học tập, giảng dạy và vận hành tại Đại học Kinh tế Thành
            phố Hồ Chí Minh (UEH).
            <br />
            Hệ thống đóng vai trò như một trung tâm tri thức số, giúp người học,
            giảng viên và viên chức tiếp cận thông tin một cách nhanh chóng,
            chính xác và nhất quán.
          </p>

          <h2>Chức năng và phạm vi hỗ trợ</h2>
          <p>Kho tri thức UEH cung cấp các nội dung hỗ trợ đa dạng, bao gồm:</p>
          <h4 id="faqs">1. Giải đáp thắc mắc</h4>
          <p>
          ...
          <h4 id="user_guide">3. Hướng dẫn sử dụng dịch vụ</h4>
          <p>
          ...
          <p>
            Với vai trò là nền tảng hỗ trợ và chia sẻ tri thức tập trung, Kho
            tri thức UEH góp phần nâng cao hiệu quả vận hành, đồng thời đảm bảo
            mọi thành viên trong hệ sinh thái UEH đều có thể tiếp cận thông tin
            và dịch vụ một cách thuận tiện, nhanh chóng và chính xác.
          </p>
        </div>
        <div className="col-3">
              ...
              items={[
                {
                  key: "#faqs",
                  href: "#faqs",
                  title: "1. Giải đáp thắc mắc",
                },
                {
                  key: "#support_request_handling",
                  href: "#support_request_handling",
                  title: "2. Tiếp nhận và xử lý yêu cầu hỗ trợ",
                },
                {
                  key: "#user_guide",
                  href: "#user_guide",
                  title: "3. Hướng dẫn sử dụng dịch vụ",
                },
              ]}
            />
          </div>
