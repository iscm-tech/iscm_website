    ...
    <div className="py-4 container">
      ...
      <div className="content-body mt-5">
        ...
        <p className="text-justify">
          ...
          Minh (UEH), được xây dựng nhằm hỗ trợ cán bộ, giảng viên và người học
          trong việc quản trị thông tin, vận hành công việc và kết nối hệ sinh
          thái UEH một cách đồng bộ, hiệu quả.
          <br />
          Thông qua UEHer, người dùng có thể truy cập nhanh chóng các hệ thống,
          dữ liệu và tiện ích phục vụ cho hoạt động học tập, giảng dạy, nghiên
          cứu và quản lý.
        </p>
        ...
        <p>
          Cung cấp các thông tin và công cụ quản lý tài khoản cá nhân, bao gồm:
        </p>
        ...
        <p>
          Nhóm chức năng này giúp người dùng đảm bảo việc truy cập và sử dụng hệ
          thống một cách liên tục và an toàn.
        </p>
        <h4>2. Thông tin UEH</h4>
        <p>
          Tổng hợp các thông tin nội bộ và văn bản quản trị chính thức của UEH:
        </p>
        <ul className="list-disc! pl-4 mb-4">
          ...
          <li className="list-item!">Nghiên cứu khoa học & hợp tác quốc tế</li>
        ...
        <h4>5. Giảng dạy và nghiên cứu khoa học</h4>
        ...
        <p>
          Đây là nhóm chức năng quan trọng đối với giảng viên và các đơn vị học
          thuật trong việc quản lý chuyên môn.
        </p>
        <h4>6. Tiện ích</h4>
        <p>
          Cung cấp các công cụ và dịch vụ hỗ trợ trong quá trình làm việc và học
          tập:
        </p>
        <ul className="list-disc! pl-4 mb-4">
        ...
        <p className="text-justify">
          ...
          <br />
          Với hệ thống chức năng toàn diện và tích hợp, UEHer không chỉ là công
          cụ quản trị mà còn là nền tảng kết nối, góp phần nâng cao hiệu quả
          hoạt động và thúc đẩy phát triển bền vững trong toàn bộ hệ sinh thái
          UEH.
        </p>
      </div>
    </div>
